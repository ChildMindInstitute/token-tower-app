export const FacebookAuthenticate = {
  appId: '1825757331088461',
  scopes: { permissions: ['public_profile', 'email'] }
};
...
export const GoogleAuthenticate = {
  ...
  iosStandaloneAppClientId: '936670915515-74oubjp3u0rj0328mb69ol98772vrp0a.apps.googleusercontent.com',
